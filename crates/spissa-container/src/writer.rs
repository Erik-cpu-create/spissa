...
impl SpissaWriter {
    ...
    pub fn new(path: impl AsRef<Path>, metadata: GlobalMetadata) -> Result<Self> {
        ...
        Ok(Self {
            ...
            chunks: Vec::new(),
            metadata,
            current_offset: SpissaHeader::SIZE as u64,
        })
    }
...
mod tests {
    ...
    fn test_writer_creates_file() {
        ...
        let writer = SpissaWriter::new(&temp, metadata).unwrap();
    ...
    fn test_writer_persists_identity_range_checksums() {
        ...
        let reader = crate::reader::SpissaReader::open(&temp).unwrap();
