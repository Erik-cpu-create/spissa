...
#[inline(always)]
fn raw_16bit_to_f32(bits: u16, dtype: spissa_container::DType) -> f32 {
    match dtype {
        spissa_container::DType::Fp16 => crate::tensor::fp16_to_f32(bits),
        spissa_container::DType::Bf16 => crate::tensor::bf16_to_f32(bits),
