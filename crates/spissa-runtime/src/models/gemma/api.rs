...
use crate::{
    ...
    LazySpissaModel, MemoryBudget, Result, RuntimeError, StreamingSamplingConfig,
};
use spissa_container::{DType, ModelConfigMetadata};
...
/// Capacity-bound mode (SPISSA_STREAM_EMBEDDING): stream the tied embedding from the
...
fn stream_embedding_enabled() -> bool {
    std::env::var("SPISSA_STREAM_EMBEDDING")
