...
use crate::{LazySpissaModel, MemoryBudget, Result, RuntimeError, StreamingSamplingConfig};
use spissa_container::ModelConfigMetadata;
...
/// weight directly.
fn decode_norm_1plus(model: &mut LazySpissaModel, name: &str, expected: usize) -> Result<Vec<f32>> {
...
pub(crate) fn gather_embedding_rows(
    ...
    if tensor.dtype == spissa_container::DType::Bf16 {
