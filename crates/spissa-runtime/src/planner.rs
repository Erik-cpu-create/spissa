...
use spissa_container::{ChunkMeta, TensorMeta};
...
fn full_decode_step(model: &LazySpissaModel, runtime_state_bytes: usize) -> PlanStep {
...
fn layer_stream_step(model: &LazySpissaModel, runtime_state_bytes: usize) -> Result<PlanStep> {
...
fn tile_stream_step(model: &LazySpissaModel, runtime_state_bytes: usize) -> Result<PlanStep> {
...
fn estimate_metadata_index_bytes(model: &LazySpissaModel) -> usize {
...
fn infer_shape_hints(model: &LazySpissaModel) -> ModelShapeHints {
