...
pub use speed::{
    ...
    parse_aip_lm_head_agreement_enabled, parse_aip_lm_head_exact_every,
    parse_aip_lm_head_novelty_gap_milli, parse_aip_lm_head_novelty_repeat_penalty_milli,
    parse_aip_lm_head_novelty_retention_milli, parse_aip_lm_head_novelty_window,
    parse_aip_lm_head_repeat_margin_adaptive_enabled, parse_aip_lm_head_repeat_margin_milli,
    parse_aip_lm_head_rescore, parse_aip_lm_head_rescore_gap_milli, parse_aip_lm_head_rows,
    ...
    select_top_abs_indices_with_recent, RamaAipPolicyKind, RamaAipProjectionDecision,
