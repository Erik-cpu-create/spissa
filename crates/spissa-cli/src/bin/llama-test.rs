...
use spissa_runtime::{
    ...
    LazySpissaModel, MemoryBudget, RamaChatSession, RamaIntegrityMode, RamaSessionPhaseTimings,
    RamaTrace, SpissaTokenizer, StreamingSamplingConfig,
};
...
fn format_rolling_suffix(stats: spissa_runtime::RamaRollingStats) -> String {
    if stats.is_empty() {
        String::new()
    } else {
        format!(
...
fn format_aip_suffix(stats: spissa_runtime::RamaExperimentalSpeedStats) -> String {
    if stats.is_empty() {
        String::new()
    } else {
...
fn format_repetition_suffix(stats: spissa_runtime::RamaRepetitionStats) -> String {
...
fn format_q8_kernel_profile_suffix() -> String {
    let Some(snapshot) = spissa_runtime::q8_kernel_profile_snapshot_and_reset() else {
        return String::new();
    };
...
fn main() -> Result<()> {
    ...
    let mut model = LazySpissaModel::open(&args.model)?;
...
mod tests {
    ...
    fn rolling_suffix_is_empty_without_activity() {
        assert_eq!(
            format_rolling_suffix(spissa_runtime::RamaRollingStats::default()),
            ""
        );
    }
    ...
    fn rolling_suffix_reports_nonzero_activity() {
        let suffix = format_rolling_suffix(spissa_runtime::RamaRollingStats {
            submitted_tasks: 8,
            worker_wakeups: 8,
    ...
    fn aip_suffix_is_empty_without_activity() {
        assert_eq!(
            format_aip_suffix(spissa_runtime::RamaExperimentalSpeedStats::default()),
            ""
        );
    }
    ...
    fn aip_suffix_reports_nonzero_activity() {
        let suffix = format_aip_suffix(spissa_runtime::RamaExperimentalSpeedStats {
            aip_policy: Some(spissa_runtime::RamaAipPolicyKind::Quality),
            ...
            layer_drift_probe: spissa_runtime::RamaLayerDriftProbeStats {
                samples: 2,
                layers: 64,
                mismatch_layers: 3,
            ...
            layer_attribution_probe: spissa_runtime::RamaLayerAttributionProbeStats {
                samples: 1,
                layer: 2,
    ...
    fn repetition_suffix_is_empty_without_activity() {
        assert_eq!(
            format_repetition_suffix(spissa_runtime::RamaRepetitionStats::default()),
            ""
        );
    }
    ...
    fn repetition_suffix_reports_nonzero_activity() {
        let suffix = format_repetition_suffix(spissa_runtime::RamaRepetitionStats {
            generated_tokens: 10,
    ...
    fn rama_trace_json_reports_phase_and_tensor_bucket_totals() {
        ...
        trace.record(spissa_runtime::RamaTraceEventInput {
    ...
    fn phase_profile_suffix_reports_prefill_and_decode_subphases() {
        let prefill = spissa_runtime::RamaSessionPhaseTimings {
            embedding_ms: 2.0,
            transformer_ms: 50.0,
            transformer_detail: spissa_runtime::RamaTransformerPhaseTimings {
        ...
        let decode = spissa_runtime::RamaSessionPhaseTimings {
            embedding_ms: 1.0,
            transformer_ms: 20.0,
            transformer_detail: spissa_runtime::RamaTransformerPhaseTimings {
                q_projection_ms: 2.0,
    ...
    fn q8_kernel_profile_suffix_is_empty_without_profile_rows() {
        let _ = spissa_runtime::q8_kernel_profile_snapshot_and_reset();
    ...
    fn q8_kernel_profile_suffix_reports_recorded_rows() {
        let _ = spissa_runtime::q8_kernel_profile_snapshot_and_reset();
        spissa_runtime::record_q8_kernel_path(
            spissa_runtime::Q8KernelPath::ContiguousI8Dot,
            2,
            4,
            0,
            2,
        ...
        spissa_runtime::record_q8_kernel_path(
            spissa_runtime::Q8KernelPath::Batch1CompleteMultiply,
            1,
            8,
            1,
            1,
        ...
        spissa_runtime::record_q8_kernel_path(
            spissa_runtime::Q8KernelPath::BatchGt1NormalBatch4Setup,
            3,
            3,
            0,
            0,
        ...
        spissa_runtime::record_q8_kernel_path(
            spissa_runtime::Q8KernelPath::BatchGt1NormalBatch4Kernel,
            3,
            3,
            0,
            12,
